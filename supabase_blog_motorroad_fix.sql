-- ============================================================
-- PISTAVIVA — Corrige o corpo da matéria Motor Road (tira negrito demais,
-- line-up em parágrafos separados). Rode no SQL Editor do Supabase.
-- ============================================================
update public.pv_blog_posts set body = $body$A contagem regressiva começou para um dos maiores encontros de duas rodas do estado de São Paulo. Nos dias 5, 6 e 7 de junho de 2026, o Centro de Eventos de Santo Antônio do Pinhal (Av. Nelson Hungria, Centro) será o destino final de um movimento gigante: a expectativa é que mais de 5 mil motociclistas subam a Serra da Mantiqueira para celebrar a nova edição do Motor Road Festival.
...
Sexta-feira, 05/06 — Big Bad Wolf (17h) e Jet Set (20h).
...
where slug = 'motor-road-festival-2026-santo-antonio-do-pinhal';

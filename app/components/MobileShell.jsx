...
const MENU = [
  { href: '/calculadora', t: 'Planejador', s: 'Rota & custo', i: <><circle cx="6" cy="19" r="2.5" /><circle cx="18" cy="5" r="2.5" /><path d="M8.5 19H15a3.5 3.5 0 0 0 0-7H9a3.5 3.5 0 0 1 0-7h6.5" /></> },
  ...
  { href: '/comboio', t: 'Comboio', s: 'Ao vivo', i: <><path d="M4 13a8 8 0 0 1 7 7M4 18a3 3 0 0 1 2 2" /><circle cx="18" cy="6" r="3" /></> },
  { href: '/loja', t: 'Loja', s: 'Vestuário', i: <><path d="M6 8h12l-1 12H7L6 8Z" /><path d="M9 8a3 3 0 0 1 6 0" /></> },
